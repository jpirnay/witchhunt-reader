...
| 2 | Show some popup indicators to let the user know something is happening  | |
| 2 | Continue with the next undealt with chapter to background indexing if the next one is already done | |
| 1 | Fix the "no chapters" message when there are no chapters | |
| 2 | Show some popup indicators to let the user know something is happening  | |
| 2 | Continue with the next undealt with chapter to background indexing if the next one is already done | |
...
| 3 | Add read badges to thumbnail overview | |
| 3 | Read cover thumbnails even when book hasnt been opened yet | |
| 1 | Replace OPDS usage of expat with new saxxml parser | |
| 2 | Update attributions | |
| 3 | Better defaults for button double-click | |