...
void EpubReaderActivity::renderContents(std::unique_ptr<Page> page, const int orientedMarginTop,
  ...
  // Grayscale AA: snapshot the BW framebuffer, render LSB+MSB planes, display,
  // then restore. Pre-check heap to avoid the chunk-retry path when success is
  // unlikely. Skip entirely when AA is off.
